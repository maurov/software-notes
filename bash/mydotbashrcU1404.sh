...
# MIT License
# Current version: optimized for XUbuntu 14.04
# NOTE: make the following link
# ~/.bashrc -> ~/utils/software-notes/mydotbashrcU1404
# ---------------------------------------------------------------------- #
...
# XOP
export XOP_HOME=$MYLOCAL/xop2.4
...
# waiting to find a clean solution with virtualenv
...
alias sloth2='python $SLOTHOME/sloth_gui.py'
alias sloth='python3 $SLOTHOME/sloth_gui.py'
#ipy 0.13 no RichIpythonWidget
alias ipylarch='python $SLOTHOME/ipylarch.py'

# oasys
alias oasys='source $MYLOCAL/py34/bin/activate; python -m oasys.canvas -l4 --force-discovery'

#pymca within virtualenv
alias pymca='source $MYLOCAL/py34/bin/activate; python -m PyMca5.PyMcaGui.pymca.PyMcaMain'
